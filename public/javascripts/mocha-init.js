...
initializeWindows = function(){
	...
	if ($('newMapLinkCheck')){
		$('newMapLinkCheck').addEvent('click', function(e){
			new Event(e).stop();
	...
	MUI.newMapWindow = function(){
		new MUI.Window({
			id: 'newMap',
			title: 'Create a new Strategy Map',			
			contentURL: '/master_maps/new',
			width: 400,
			height: 350			
	...
	if ($('openMapLinkCheck')){
		$('openMapLinkCheck').addEvent('click', function(e){
			
			new Event(e).stop();
			MUI.openMapWindow();
		});
	}
	MUI.openMapWindow = function(){
		new MUI.Window({
			id: 'openMap',
			title: 'Open an existing Strategy map',			
			contentURL: '/master_maps/open',
			width: 400,
			height: 350			
...
initializeColumns = function() {
	...
	new MUI.Column({
		...
		width: 250,
		resizeLimit: [10, 300],
		onCollapse: function(){c1Collapse=0;if(c2Collapse==0)createDiv();},
        onExpand: function(){c1Collapse=1;deleteDiv();}
	});
	...
	new MUI.Column({
		...
		width: 220,
		resizeLimit: [10, 300],
        onCollapse: function(){c2Collapse=0;if(c1Collapse==0 )createDiv();},
        onExpand: function(){c2Collapse=1;deleteDiv();}
	});
...
function deleteDiv()
{
	var newDiv=document.getElementById("tip");
	if(newDiv)
